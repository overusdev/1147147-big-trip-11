...
// const siteEditMainElement = document.querySelector(`.trip-events__list`);
// const siteEditEventElement = siteEditMainElement.querySelector(`.trip-events__item`);

// console.log(siteEditMainElement);
// console.log(siteEditEventElement);
...
// render(siteEditEventElement, createEditEventTemplate(), `beforeend`);
